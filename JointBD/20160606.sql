...
CREATE TABLE `calificacion` (
  ...
  `calificado` varchar(10) DEFAULT 'false',
  PRIMARY KEY (`idcalificacion`),
  KEY `ttc_idx` (`idtipo`),
  CONSTRAINT `ttc` FOREIGN KEY (`idtipo`) REFERENCES `tipocalificacion` (`idtipoCalificacion`) ON DELETE CASCADE ON UPDATE CASCADE
...
INSERT INTO `calificacion` VALUES (14,NULL,3,NULL,NULL,'false'),(15,'2016-6-5',3,'5','Jesus es muy guapo','true'),(16,NULL,3,NULL,NULL,'false'),(17,NULL,3,NULL,NULL,'false');
...
INSERT INTO `configuraciontrabajador` VALUES (1,13,'true'),(2,19,'true'),(3,14,'true'),(4,9,'true'),(6,18,'true');
...
INSERT INTO `direccion` VALUES (8,'AV barrios','11b','Reyes Iztacala','Tlalnepantla',54090,'Estado de México'),(9,'AV Barrios','11B','Reyes Iztacala','Tlalnepantla',54090,'Estado de México'),(10,'AV Revolucion','42','Los Matir','Naucalpan',53105,'Estado de México');
/*!40000 ALTER TABLE `direccion` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `fechacalificacion`
--

DROP TABLE IF EXISTS `fechacalificacion`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `fechacalificacion` (
  `idCalificacion` int(11) NOT NULL,
  `anio` int(11) DEFAULT NULL,
  `mes` int(11) DEFAULT NULL,
  `dia` int(11) DEFAULT NULL,
  PRIMARY KEY (`idCalificacion`),
  CONSTRAINT `fechacalificacion` FOREIGN KEY (`idCalificacion`) REFERENCES `calificacion` (`idcalificacion`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_bin;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `fechacalificacion`
--

LOCK TABLES `fechacalificacion` WRITE;
/*!40000 ALTER TABLE `fechacalificacion` DISABLE KEYS */;
INSERT INTO `fechacalificacion` VALUES (15,2016,6,5);
/*!40000 ALTER TABLE `fechacalificacion` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `trabajador` VALUES (1,2015630114,'true','\'sistema/imagenesUsuario/2015630114.png\'','Julio Diaz Rodriguez','1995-06-14',20,'jdiazrdgz@gmail.com','123456',4,'1998-02-10','true'),(2,2015630113,'true','\'sistema/imagenesUsuario/userImage.png\'','Jesus Altamirano Lara','1995-02-01',21,'chuy@gmail.com','123456',3,'1998-02-10','true'),(3,2015630112,'true','imagenesUsuario/userImage.png','Brayan Ramos Reyes','1996-08-26',19,'brayanramosreyes@gmail.com','123456',2,'1998-02-10','true'),(4,2015630111,'true','imagenesUsuario/userImage.png','Gran Señor Imaginario','1995-06-14',20,'setrules@gmail.com','123456',1,'1998-02-10','true'),(5,2015630110,'true','imagenesUsuario/userImage.png','Señor Prueba s','1995-08-26',18,'pruebas@gmail.com','123456',1,'1998-02-10','true'),(6,2015630109,'true','imagenesUsuario/userImage.png','Dae Oh Young','1990-06-11',26,'coreano@gmail.com','123456',4,'1998-02-10','true'),(7,2015630108,'false','imagenesUsuario/userImage.png',NULL,NULL,NULL,NULL,NULL,3,NULL,'false'),(8,2015630107,'false','imagenesUsuario/userImage.png',NULL,NULL,NULL,NULL,NULL,1,NULL,'false');
/*!40000 ALTER TABLE `trabajador` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `trabajadorcalificacion`
--

DROP TABLE IF EXISTS `trabajadorcalificacion`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `trabajadorcalificacion` (
  `idcalificacion` int(11) NOT NULL,
  `idcalificador` int(11) DEFAULT NULL,
  `idcalificado` int(11) DEFAULT NULL,
  PRIMARY KEY (`idcalificacion`),
  KEY `trabajadorcalificador_idx` (`idcalificador`),
  KEY `trabajadorcalificado_idx` (`idcalificado`),
  CONSTRAINT `califcalif` FOREIGN KEY (`idcalificacion`) REFERENCES `calificacion` (`idcalificacion`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `trabajadorcalificado` FOREIGN KEY (`idcalificado`) REFERENCES `trabajador` (`idtrabajador`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `trabajadorcalificador` FOREIGN KEY (`idcalificador`) REFERENCES `trabajador` (`idtrabajador`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_bin;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `trabajadorcalificacion`
--

LOCK TABLES `trabajadorcalificacion` WRITE;
/*!40000 ALTER TABLE `trabajadorcalificacion` DISABLE KEYS */;
INSERT INTO `trabajadorcalificacion` VALUES (14,2,1),(15,1,2),(16,2,1),(17,1,2);
/*!40000 ALTER TABLE `trabajadorcalificacion` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `trabajadorviajecalificacion` VALUES (1,14,9),(2,15,9),(1,16,10),(2,17,10);
...
CREATE TABLE `viaje` (
  ...
  `finalizado` varchar(10) DEFAULT 'false',
...
INSERT INTO `viaje` VALUES (9,9,'2016-06-07','2016-06-08',100,'05:50','09:50',1,2,'true'),(10,10,'2016-06-18',NULL,NULL,'20:52',NULL,1,2,'false');
