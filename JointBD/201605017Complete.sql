CREATE DATABASE  IF NOT EXISTS `joint` /*!40100 DEFAULT CHARACTER SET utf8 COLLATE utf8_bin */;
USE `joint`;
...
INSERT INTO `configuraciontrabajador` VALUES (1,10,'false'),(2,3,'false'),(3,4,'false');
...
CREATE TABLE `tipocalificacion` (
  ...
  `idtipocalificacion` varchar(45) NOT NULL,
  PRIMARY KEY (`idtipocalificacion`),
  KEY `cargocalif_idx` (`idcargo`),
  KEY `tipocalif _idx` (`tipocalificacion`),
  CONSTRAINT `cargocalif` FOREIGN KEY (`idcargo`) REFERENCES `cargo` (`idcargo`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `tipocalif ` FOREIGN KEY (`tipocalificacion`) REFERENCES `calificacion` (`tipo`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `trabajador` VALUES (1,2015630114,'true','\'sistema/imagenesUsuario/2015630114.png\'','Julio Diaz Rodriguez','14-06-1995',20,'jdiazrdgz@gmail.com','123321',4,'11/05/2016'),(2,2015630113,'true','\'sistema/imagenesUsuario/userImage.png\'','Jesus Altamirano Lara','1995-02-01',21,'chuy@gmail.com','123456',3,'13/05/2016'),(3,2015630112,'true','imagenesUsuario/userImage.png','Brayan Ramos Reyes','1996-08-26',19,'brayanramosreyes@gmail.com','123456',2,'15/05/2016');
...
CREATE TABLE `trabajadorcalificacion` (
  ...
  PRIMARY KEY (`idCalificacion`,`idCalificador`,`idCalificado`),
  KEY `trabajadorcalificador_idx` (`idCalificador`,`idCalificado`),
  KEY `trabajadorCalificado_idx` (`idCalificado`),
  CONSTRAINT `calificacion` FOREIGN KEY (`idCalificacion`) REFERENCES `calificacion` (`idcalificacion`) ON DELETE CASCADE ON UPDATE CASCADE,
...
CREATE TABLE `viaje` (
  ...
  PRIMARY KEY (`idviaje`,`fechasalida`,`horasalida`,`idchofer`,`idlogistica`),
...
-- Dump completed on 2016-05-17 23:02:47
